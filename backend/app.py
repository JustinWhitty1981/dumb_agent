...
SYSTEM_PROMPT = (
    ...
    "and memory storage tools. \n\n"
    "Your tools include:\n"
    "- **current_time()**: Get the current date and time\n"
    "- **search_web(query)**: Search the web using DuckDuckGo. Provide a search query.\n"
...
async def chat(request: ChatRequest):
    ...
    try:
        ...
        return ChatResponse(response=response_text, thread_id=request.thread_id or "default")
